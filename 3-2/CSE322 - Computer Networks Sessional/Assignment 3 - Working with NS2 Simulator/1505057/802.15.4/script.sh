...
for((i=4; i<=20; i=i+4))
do
	ns wirelessStatic_802_15.4_tcp.tcl $i 20 100 400
	echo "~~~~~~~~~~~~~~~~"
	awk -f wirelessStatic_802_15.4_tcp.awk staticOut.tr
	echo "~~~~~~~~~~~~~~~~"
done
...
do
	ns wirelessStatic_802_15.4_tcp.tcl 20 $i 100 450
	echo "~~~~~~~~~~~~~~~~"
	awk -f wirelessStatic_802_15.4_tcp.awk staticOut.tr
	echo "~~~~~~~~~~~~~~~~"
done
...
do
	...
	ns wirelessStatic_802_15.4_tcp.tcl 12 20 $i 250
	echo "~~~~~~~~~~~~~~~~"
	awk -f wirelessStatic_802_15.4_tcp.awk staticOut.tr
	echo "~~~~~~~~~~~~~~~~"
done
...
do
	...
	ns wirelessStatic_802_15.4_tcp.tcl 12 20 100 $i 
	echo "~~~~~~~~~~~~~~~~"
	awk -f wirelessStatic_802_15.4_tcp.awk staticOut.tr
	echo "~~~~~~~~~~~~~~~~"
done
